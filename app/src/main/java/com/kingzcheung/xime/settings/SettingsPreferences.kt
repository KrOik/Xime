...
object SettingsPreferences {
    ...
    fun isDouTypeTwoPassRetryEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_TWOPASS_RETRY, true)
    fun setDouTypeTwoPassRetryEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_TWOPASS_RETRY, value).apply()
    fun isDouTypeStrongDdcEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_STRONG_DDC, true)
    fun setDouTypeStrongDdcEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_STRONG_DDC, value).apply()
    ...
    fun isDouTypeTextSegEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_TEXT_SEG, false)
    fun setDouTypeTextSegEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_TEXT_SEG, value).apply()
    ...
    fun isDouTypeShowUtterancesEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_SHOW_UTTERANCES, false)
    fun setDouTypeShowUtterancesEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_SHOW_UTTERANCES, value).apply()
    fun isDouTypePrintChineseEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_PRINT_CHINESE, false)
    fun setDouTypePrintChineseEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_PRINT_CHINESE, value).apply()
    ...
    fun isDouTypeRemoveSpacesEngEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_REMOVE_SPACES_ENG, true)
    fun setDouTypeRemoveSpacesEngEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_REMOVE_SPACES_ENG, value).apply()
    fun isDouTypeDisableUserWordsEnabled(context: Context) = getPrefs(context).getBoolean(KEY_DOUTYPE_DISABLE_USER_WORDS, false)
    fun setDouTypeDisableUserWordsEnabled(context: Context, value: Boolean) = getPrefs(context).edit().putBoolean(KEY_DOUTYPE_DISABLE_USER_WORDS, value).apply()
    fun getDouTypeLanguage(context: Context) = getPrefs(context).getString(KEY_DOUTYPE_LANGUAGE, "zh-CN") ?: "zh-CN"
    fun setDouTypeLanguage(context: Context, value: String) = getPrefs(context).edit().putString(KEY_DOUTYPE_LANGUAGE, value).apply()
    fun getDouTypeResultType(context: Context) = getPrefs(context).getString(KEY_DOUTYPE_RESULT_TYPE, "full") ?: "full"
    fun setDouTypeResultType(context: Context, value: String) = getPrefs(context).edit().putString(KEY_DOUTYPE_RESULT_TYPE, value).apply()
    fun getDouTypeInputMode(context: Context) = getPrefs(context).getString(KEY_DOUTYPE_INPUT_MODE, "tool") ?: "tool"
    fun setDouTypeInputMode(context: Context, value: String) = getPrefs(context).edit().putString(KEY_DOUTYPE_INPUT_MODE, value).apply()
